...
const Thanks = () => (
    <Main meta={<Meta title="Gracias" description="Confirmacion de donativo"/>}>
        <>
            {/*
                ...
                <div>
                    <div className="mx-auto max-w-2xl py-16 px-4 sm:px-6 sm:py-24 lg:grid lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8 lg:py-32 xl:gap-x-24">
                        <div className="lg:col-start-2">
                            <h1 className="text-sm font-medium text-indigo-600">Cargo exitoso</h1>
                            <p className="mt-2 text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl">Gracias por tu donaci&oacute;n</p>
                            <p className="mt-2 text-base text-gray-500">
                                Muchas gracias por tu donaci&oacute;n
                            </p>
                            ...
                            {/*    <div className={'col-span-1 columns-1'}>*/}
                            ...
                            <div className="mt-16 border-t border-gray-200 py-6 text-right">
                                <a href="https://ayudateadar.org.mx/" className="text-sm font-medium text-indigo-600 hover:text-indigo-500">
                                    Ir al sitio de la fundaci&oacute;n
